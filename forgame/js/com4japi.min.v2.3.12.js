...
com4j.config = {
    ...
    ForJoyH5_DefaultBigLogo: "./logo/default_b.png?1466980738",
    _ForJoyH5_BigLogo: "./logo/default_b.png?1466980738",
    ...
    ForJoyH5_DefaultSmallLogo: "./logo/default_s.png?1466980738",
    _ForJoyH5_SmallLogo: "./logo/default_s.png?1466980738",
...
com4j.init = function() {
    ...
    com4j.config.v = v;
    var url = com4j.config.host + "setting/" + pubid + ".json?" + v;
    $.get(url, function(data, status, xhr) {
        if (status == "success") {
            for (var i in data) {
                var key = "ForJoyH5_" + i;
        ...
        if (com4j.config.ForJoyH5_ShowAd && !com4j.ad.check()) {
            ...
            $.get("https://geoip-db.com/json/", function(data) {
